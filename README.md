For task 1, the formulas can be typed into 'formulas.txt', each on a new line and task1.py will print the corresponding parse trees into the console when run. There is also an option to directly
